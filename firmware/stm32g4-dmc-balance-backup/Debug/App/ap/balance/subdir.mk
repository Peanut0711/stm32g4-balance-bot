...
C_SRCS += \
../App/ap/balance/balance.c 

OBJS += \
./App/ap/balance/balance.o 

C_DEPS += \
./App/ap/balance/balance.d 


# Each subdirectory must supply rules for building sources it contributes
App/ap/balance/%.o App/ap/balance/%.su App/ap/balance/%.cyclo: ../App/ap/balance/%.c App/ap/balance/subdir.mk
...
clean: clean-App-2f-ap-2f-balance

clean-App-2f-ap-2f-balance:
	-$(RM) ./App/ap/balance/balance.cyclo ./App/ap/balance/balance.d ./App/ap/balance/balance.o ./App/ap/balance/balance.su

.PHONY: clean-App-2f-ap-2f-balance
