...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : IMU_INT1_Pin IMU_INT2_Pin L_ENC1_Pin L_ENC2_Pin */
  GPIO_InitStruct.Pin = IMU_INT1_Pin|IMU_INT2_Pin|L_ENC1_Pin|L_ENC2_Pin;
  ...
  /*Configure GPIO pins : R_ENC1_Pin R_ENC2_Pin LED_Pin */
  GPIO_InitStruct.Pin = R_ENC1_Pin|R_ENC2_Pin|LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
